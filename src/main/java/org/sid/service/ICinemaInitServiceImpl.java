...
public class ICinemaInitServiceImpl implements ICinemaInitService{
	...
	public void initSeances() {
		...
		Stream.of("12:00","13:00","20:00","23:00").forEach(s->{
	...
	public void initCategories() {
		Stream.of("Histoire","Horror","Drama","Romance").forEach(cat->{
	...
	public void initFilms() {
		...
		Stream.of("Harry Potter","Forrest Gump","Saw","Le parrain").forEach(titreFilm->{
			Film film=new Film();
